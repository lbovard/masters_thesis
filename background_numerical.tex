...
\nu k^{2} \Rightarrow \nu k_{max}^{2-i}k^{i}.
\end{align}
Throughout this thesis, we will use $i=4$, although $i=8$ is also common \cite{lindborg2006,augier2012}.
