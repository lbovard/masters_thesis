...
\section{Structure (to be finished)} 
\begin{figure}
\begin{center}
\includegraphics[scale=0.85]{velocity_fields_kz_6}
\caption{Imaginary part of the growth rate for $F_{h}=0.05$ and $Re=20{,}000$ (blue) and $Re=10{,}000$ (black).}
\end{center}
\end{figure} 
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.85]{velocity_fields_kz_60}
\caption{Imaginary part of the growth rate for $F_{h}=0.05$ and $Re=20{,}000$ (blue) and $Re=10{,}000$ (black).}
\end{center}
\end{figure} 
\begin{figure}
\begin{center}
\includegraphics[scale=0.85]{velocity_fields_kz_20}
\caption{Imaginary part of the growth rate for $F_{h}=0.05$ and $Re=20{,}000$ (blue) and $Re=10{,}000$ (black).}
\end{center}
\end{figure} 
\begin{figure}
